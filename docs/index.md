...
<div class="grid">
    ...
    <a href="Other#Open_VPN">
        ...
        <header class="entry-header">
        <div class="entry-thumbnail">
            <img src="https://cdn.mos.cms.futurecdn.net/iobkZ4mP5iiM5b2fj4jEHn-650-80.jpg.webp" alt="Open VPN"/>
        </div>
    ...
    <a href="Other#UDP">
        ...
        <h2 class="my_title">Hysteria 2  and TUIC</h2>
        <p class="my_text">
    ...
    <a href="Xray">
        ...
        <header class="entry-header">
        <div class="entry-thumbnail">
            <img src="https://archive.org/download/github.com-XTLS-Xray-core_-_2021-03-22_05-20-53/cover.jpg" alt="Xray"/>
        </div>
    ...
    <a href="Other#NordVPN">
        ...
        <header class="entry-header">
        <div class="entry-thumbnail">
            <img src="https://d3ozokkbblvuwo.cloudfront.net/wp-content/uploads/2023/03/NordVPN-logo-thumbnail.jpg" alt="NordVPN"/>
        </div>
        <h2 class="my_title">NordVPN</h2>
        <p class="my_text">
            نصب و راه اندازی نورد وی پی ان
        </p>
        </header>
        </article>
    </a>
...
| روش | توضیحات |
| --- | --- |
| [Fragment](Fragment) | در این روش پکیت ها تکه تکه می شوند و نیاز به دامنه و سرور کثیف هست |
